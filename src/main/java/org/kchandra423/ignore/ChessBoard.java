...
public class ChessBoard extends PApplet {
    ...
    public ChessBoard() {
        try {
            if (!new File("src/main/resources/data/starting_pos.dat").exists()) {
                throw new FileNotFoundException();
            }
            FileInputStream fin = new FileInputStream("src/main/resources/data/starting_pos.dat");
    ...
    public void setup() {
        ...
        for (File file : listOfFiles) {
            if (file.isFile()) {
                ...
                images.put(Piece.fromValue(name), loadImage("src/main/resources/images/" + file_name));
            }
        }
    ...
    private static void saveBoard(Board board) {
        ...
        try {
            fout = new FileOutputStream("src/main/resources/data/starting_pos.dat");
